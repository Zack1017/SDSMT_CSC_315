...
int main()
{
    ...
    g4.writeDOT("g4.dot", "label", true);
    g4.writePNG("g4.dot", "g4.png");
    cout << "(Wrote g4.dot)\n";
    cout << "------------------------\n\n";

    Graph g4b(6, true);
    g4b.loadFromDOT("../data/i_fg.dot", true, true);
    maxflow = g4b.maxFlowEdmondsKarp(0,5);
    cout << "The maximum flow between 0 and 5 is: " << maxflow << "\n";
    g4b.writeDOT("g4b.dot", "label", true);
    g4b.writePNG("g4b.dot", "g4b.png");
    cout << "(Wrote g4b.dot)\n";
